...
export const MYSQL_CONFIG = {
  docker: {
    ...
    volume:
      PROJECT_ENV === PROJECT_ENV_ENUM.development
        ? '/e/Project/billd-live-server/docker/mysql'
        : '********************',
  },
  database:
    PROJECT_ENV === PROJECT_ENV_ENUM.development
...
export const REDIS_CONFIG = {
  docker: {
    ...
    volume:
      PROJECT_ENV === PROJECT_ENV_ENUM.development
        ? '/e/Project/billd-live-server/docker/redis'
        : '*************',
  },
  database: 0,
  socket: {
...
export const SRS_CONFIG = {
  docker: {
    ...
    volume:
      PROJECT_ENV === PROJECT_ENV_ENUM.development
        ? '/e/Project/billd-live-server/docker/srs'
        : '*************',
  },
  // CANDIDATE填你的本机ip地址
  CANDIDATE:
    PROJECT_ENV === PROJECT_ENV_ENUM.development
      ? `192.168.72.150` // WARN mac可以这样获取本机ip，但是win不行，自己找本地ip
      : '*************',
}; // SRS配置
